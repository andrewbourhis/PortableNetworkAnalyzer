 ...
 */
// Settling Time Cycles Decoder constants
#define NUM_CYCLES_X1		(0b00000000)
#define NUM_CYCLES_X2		(0b00000010)
#define NUM_CYCLES_X4		(0b00000110)
...
class AD5933 {
    public:
        ...
        static bool setSettlingCycles(int n,int m); 
        ...
        static bool setExcitationVoltageRange(unsigned int); 
